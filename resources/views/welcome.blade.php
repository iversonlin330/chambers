...
{{--                >--}}
                  ...
                  <g id="g-app-brand" stroke="none" stroke-width="1" fill="none" fill-rule="evenodd">
                    ...
                    <span class="app-brand-text demo menu-text fw-bolder ms-2">定恆法律事務所</span>
                </a>
            ...
            <ul class="menu-inner py-1">
                ...
                <li class="menu-item">
                    <a href="{{ url('/costs') }}" class="menu-link">
                        <i class="menu-icon tf-icons bx bx-home-circle"></i>
                        <div data-i18n="Analytics">查看費用紀錄</div>
                    </a>
                </li>
                <li class="menu-item">
                    <a href="{{ url('/hours/create') }}" class="menu-link">
                        <i class="menu-icon tf-icons bx bx-home-circle"></i>
                        <div data-i18n="Analytics">時數登錄</div>
                    </a>
                </li>
                <li class="menu-item">
                    <a href="{{ url('/hours') }}" class="menu-link">
                        <i class="menu-icon tf-icons bx bx-home-circle"></i>
                        <div data-i18n="Analytics">查看時數登錄</div>
                    </a>
                </li>
                <li class="menu-item">
                    <a href="{{ url('/hours/export') }}" class="menu-link">
                        <i class="menu-icon tf-icons bx bx-home-circle"></i>
                        <div data-i18n="Analytics">匯出時數</div>
                    </a>
                </li>
                <li class="menu-item">
                    <a href="{{ url('/whitelist') }}" class="menu-link">
                        <i class="menu-icon tf-icons bx bx-home-circle"></i>
                ...
                <li class="menu-item">
                    <a href="{{ url('/logs') }}" class="menu-link">
                        <i class="menu-icon tf-icons bx bx-home-circle"></i>
                        <div data-i18n="Analytics">系統紀錄</div>
                    </a>
                </li>
                        ...
                        <div class="table-responsive text-nowrap">
                            <table class="table">
                                ...
                                <tr class="table-warning">
                                    <td><i class="fab fa-react fa-lg text-info me-3"></i> <strong>React Custom</strong>
                                    </td>
                                    <td>Ted Richer</td>
                                    <td>
                                        <ul class="list-unstyled users-list m-0 avatar-group d-flex align-items-center">
